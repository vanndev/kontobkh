...
class HomeController extends GetxController {
  ...
  void loadProducts() {
    final availableImages = [
      ...
      "assets/products/img_L_45.jpg",
      "assets/products/img_L_46.jpg",
      "assets/products/img_L_47.jpg",
      "assets/products/img_L_48.jpg",
    ...
    for (int i = 0; i < availableImages.length; i++) {
      final image = 'https://vanndev.github.io/kontobkh/${availableImages[i]}';
